<div class="modal fade" id="update-smalldoor{{$item->id}}">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">Update Smalldoor</h4>
        ...
        <div class="modal-body">
            ...
            <div class="card card-info">
                ...
                <!-- /.card-header -->
                <form action="{{ route('smalldoor.update', $item->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                        <div class="card-body">
