        ...
        <div class="row">
          <div class="col-md-9 col-sm-8">
              ...
              <p class="lead" style="color: rgb(0, 0, 0)">
                   <i class="fa fa-map-marker"></i> {{$detailCareertwo->location}} &nbsp;&nbsp;
                   <i class="fa fa-calendar"></i> {{$detailCareertwo->schedule}} &nbsp;&nbsp;
                   <i class="fa fa-file"></i> {{$detailCareertwo->day_of}}
              </p>
              ...
              <div class="form-group">
                <h5>{{$detailCareertwo->job}}</h5>
              </div>

              {{ $detailCareertwo->requirment }}
          ...
          <div class="col-md-3 col-sm-4">
            ...
            <div>
              <img src="{{asset('/upload/careertwo/'.$detailCareertwo->careertwo->filename)}}" alt="" class="img-fluid wc-image">
            </div>
          ...
          <div class="col-md-3">
            ...
            <div class="left-content">
              <p>
                ...
                <strong>{{$detailCareertwo->name_contact}}</strong>
              </p>
              ...
              <p>
                ...
                <strong>
                  <a href="tel:{{$detailCareertwo->phone_contact}}">{{$detailCareertwo->phone_contact}}</a>
                </strong>
              </p>
              ...
              <p>
                ...
                <strong>
                  <a href="mailto:{{$detailCareertwo->email_contact}}">{{$detailCareertwo->email_contact}}</a>
                </strong>
              </p>
              ...
              <p>
                ...
                <strong>
                  <a href="https://{{$detailCareertwo->website_contact}}/">{{$detailCareertwo->website_contact}}</a>
                </strong>
              </p>
            </div>
          </div>
