...
<div class="content-header">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <button type="button" class="btn bg-gradient-success" data-toggle="modal" data-target="#create-typical">
                    ...
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                @empty
                                <tr>
                                    <td class="text-center text-mute" colspan="6"><b>Data typical is empty</b></td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table><br>
  ...
  <div class="modal fade" id="create-typical">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">Create Typical</h4>
