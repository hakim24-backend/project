        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                      <form action="{{ route('career.storeDetail', $career->id) }}" method="POST" enctype="multipart/form-data">
                      @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="">Job Description</label>
                                    <textarea id="summernote" name="desc_job"></textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="">Location Description</label>
                                    <textarea id="summernote1" name="desc_location"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
