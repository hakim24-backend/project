...
<div class="container">
	<div class="row banner">
		...
		<p class="text-center">В НАСТОЯЩИЙ МОМЕНТ НА ПРЕДПРИЯТИЯХ ХОЛДИНГА SOYUZ GROUP ОТКРЫТЫ СЛЕДУЮЩИЕ ВАКАНСИИ</p>
	</div>
	<div class="row jobSec">
	<div class="row bgRow pdtb">
	...
	<div class="row pdtb">
		<div class="center">
			<div class="row contentRow border">
				<div class="leftBox">
					<p>
...
<strong>заработная плата:</strong> 80 000 руб
					...
					<p>
<strong>место работы:</strong> г. Санкт-Петербург, ул. Шпалерная, д.51А, БЦ «Таврический»
					</p>
				</div>
			</div>
		</div>
